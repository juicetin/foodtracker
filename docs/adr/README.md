...
Lightweight ADRs tracking key technical decisions for the foodtracker project.
...
|-----|-------|--------|------|
| [001](001-python-notebook-for-food-detection-poc.md) | Python notebook for food detection POC | Accepted | 2026-02-08 |
