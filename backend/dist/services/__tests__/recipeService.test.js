...
describe('Recipe Service', () => {
    describe('createRecipeFromEntry', () => {
        it('should create a recipe from a food entry', async () => {
            ...
            const recipe = await recipeService.createRecipeFromEntry(testUserId, entry.id, 'Chicken & Rice Bowl', 'My favorite lunch meal');
        ...
        it('should copy photos from the entry', async () => {
            ...
            const recipe = await recipeService.createRecipeFromEntry(testUserId, entry.id, 'Garden Salad');
    ...
    describe('useRecipe', () => {
        it('should create a new entry from a recipe', async () => {
            ...
            const recipe = await recipeService.createRecipeFromEntry(testUserId, entry.id, 'Tuna Avocado Bowl');
